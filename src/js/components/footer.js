import { footerConstant } from "../utils/constants";
...
export default function footer() {
  ...
  <div class="flex items-center justify-center flex-wrap gap-4 py-4">
      <a
      href="#"
      class="block p-3 rounded-full transition ease-in-out duration-300 hover:bg-secondary-100"
      >
      <svg
          width="24"
          height="24"
  ...
  <div class="flex items-center justify-center flex-wrap gap-3 px-4 sm:gap-5 max-w-[940px] mx-auto">${footerLinks.join(
    " "
  )}</div>
  <div class="flex items-center justify-center py-4">
      <img class="py-2" src="/amazon-logo.svg" alt="" />
  </div>
  <div class="py-1.5 text-center">
      <p class="text-xs text-primary/70 tracking-wide">
      © 1990-2023 by IMDb.com, Inc.
      </p>
  </div>
  </div>`;
  return (footerId.innerHTML = footerContent);
}
